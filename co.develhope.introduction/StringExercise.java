...
public class StringExercise {
    ...
    private static void exercise1() {
        ...
        //creating a string holding name of a person
        String name = "Maron";
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Maron";
        String middleName = "Murangiri";
        String lastName = "Rimberia";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "15" + true+ 20 + 30.82 + 'v'; // <--- Edit this line
